...
//    Observable<RxMessage<String>> obs1 = rxEventBus.send("foo", "ping!A");
//    Observable<RxMessage<String>> obs2 = rxEventBus.send("foo", "ping!B");
//    Observable<RxMessage<String>> obs3 = rxEventBus.send("foo", "ping!C");
